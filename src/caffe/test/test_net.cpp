...
class NetTest : public MultiDeviceTest<TypeParam> {
 ...
 protected:
  ...
  virtual void InitNetSamplePluginString(const string& proto) {
    NetParameter param;
    CHECK(google::protobuf::TextFormat::ParseFromString(proto, &param));
    net_.reset(new Net<Dtype>(param));
  }

  virtual void InitNetSamplePluginFileWithState(const string& proto,
  ...
  virtual void InitTinyNet(const bool force_backward = false,
    ...
    InitNetSamplePluginString(proto);
  }
  ...
  virtual void InitUnsharedWeightsNet(const Dtype* loss_weight = NULL,
    ...
    proto <<
        ...
        "} ";
    InitNetSamplePluginString(proto.str());
  }
  ...
  virtual void InitAllInOneNet(Phase phase = caffe::TRAIN,
    ...
    string proto =
      ...
      "  include { phase: TEST stage: 'val' } "
      "} ";
    InitNetSamplePluginFileWithState(proto, phase, level, stages);
  }
