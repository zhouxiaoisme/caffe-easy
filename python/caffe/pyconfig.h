...
#			ifdef _DEBUG
#				 pragma comment(lib,"python27_d.lib") // modified by zx @ 20170502 for compiling pycaffe debug version lib
...
#ifdef _DEBUG
// #	define Py_DEBUG  # disabled by zx @ 20170502 for compiling pycaffe debug version lib
#endif
